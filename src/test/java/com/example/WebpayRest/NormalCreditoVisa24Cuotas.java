...
public class NormalCreditoVisa24Cuotas {
  ...
  @Test
  public void testNormalCreditoVisa24Cuotas() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='El valor de cada cuota dependerá del banco al que pertenece tu tarjeta.'])[1]/following::button[1]")).click();
    Thread.sleep(4000);//para que no vaya tan rapido
